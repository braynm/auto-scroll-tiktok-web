//const container = document.querySelector('[data-e2e="feed-video"]')
...
(function(globalSope) {
     ...
     */
    function getConditionalCalback(selector, callback) {
        return function(e) {
...
const videoFromFeed = document.querySelectorAll('div[data-e2e="feed-video"]');
videoFromFeed.forEach(item => {
  item.onclick = () => {
    console.log('lockededededed')
  }
})

addDynamicEventListener(document.body, 'click', 'div[data-e2e="feed-video"]', function (e) {
    console.log('Clicked', e.target.innerText);
});

//videoFromFeed.onclick = function() {
  //console.log('clicked..')
  //const browseVideo = document.querySelector('[data-e2e="browse-video"]')
  //console.log({
    //browseVideo,
    ////browseVideo: browseVideo.querySelector('video')
  //})
  ////const browseVideo.onended = function() {
    ////alert(1)
  ////}
  ////console.log({ browseVideo })
//}
